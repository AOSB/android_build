...
# gcc 4.10 no longer exist in gnu trees so do not reference it here.
# dalvik solely relies on the android toolchain, so a check of arm-eabi version is not needed.
ifneq ($(filter 4.6 4.6.% 4.7 4.7.% 4.8 4.8.% 4.9 4.9.% 5.0 5.0.%, $(TARGET_GCC_VERSION_AND)),)
